	...
	************************************************************************************************************/	
	...
	function showPreview2(imagePath,inputObj)
	{		
		$("#DHTMLgoodies_largeImage a").attr('href', imagePath);
		$("#DHTMLgoodies_largeImage img").fadeOut('1000', function(){$(this).attr('src', imagePath).fadeIn('1000')});
	}
